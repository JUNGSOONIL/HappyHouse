          ...
          <table class="table align-items-center mb-0">
            <thead>
              <tr>
                <th
                  class="
                    text-center text-uppercase text-secondary text-s
                    font-weight-bolder
                    opacity-7
                  "
                >
...
import DetailModal from "./AptDetailModal.vue";
...
export default {
  ...
  mounted() {
    if (window.kakao && window.kakao.maps) {
      ...
      script.src =
        "http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=687901a3339404e20ad9c6557010888d&libraries=services";
