<template>
  <div class="row w-50">
    ...
    <div class="col-3 pt-2" style="background-color: white">
      <span class="input-group input-group-static mb-4">
        <label for="sidoOption" class="ms-0">시.도</label>
        <select class="form-control" id="sidoOption" @change="gugunList">
          <option
    ...
    <!-- <span class="dropdown ms-3 me-3">
        ...
        >
          <li>
            <a class="dropdown-item" data-value="sido.value" @click="gugunList">
              {{ sido.text }}
            </a>
          </li>
        </ul>
    ...
    <div class="col-3 pt-2" style="background-color: white">
      <span class="input-group input-group-static mb-4">
        ...
        <select class="form-control" id="gugunOption" @change="dongList">
          <option
    ...
    <!-- <span class="dropdown ms-3 me-3">
        ...
        >
          <li>
            <a class="dropdown-item" data-value="gugun.value" @click="dongList">
              {{ gugun.text }}
            </a>
          </li>
        </ul>
    ...
    <div class="col-3 pt-2" style="background-color: white">
      <span class="input-group input-group-static mb-4">
        ...
        <select class="form-control" id="dongOption" @change="searchApt">
          <option
      ...
      <!-- <span class="dropdown ms-3 me-3">
        ...
        >
          <li>
            <a class="dropdown-item" data-value="dong.value" @click="searchApt">
              {{ dong.text }}
            </a>
          </li>
        </ul>
  ...
  methods: {
    ...
    searchApt() {
      ...
      if (this.dongName != null)
        this.$store.dispatch("getHouseList", this.dongName);
