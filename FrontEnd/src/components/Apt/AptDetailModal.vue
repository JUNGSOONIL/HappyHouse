      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="card">
              <img src="@/assets/img/apt/houselist.jpg" />
            </div>
            <div class="card">
              <div class="table-responsive">
                <table class="text-center" style="width: 100%">
                  ...
                  <tr class="m-3">
                    <td>
                      <h6 class="mb-0 text-s font-weight-bolder">
                        최근거래금액
                      </h6>
                    </td>
                    <td>
                      <p class="text-s mb-0">
                        {{
                          (parseInt(
                            $store.state.houses.house.recentPrice.replace(
                              ",",
                              ""
                            )
                          ) *
          ...
          <div class="modal-footer">
            <button
              ...
              v-if="
                ...
                $store.state.houses.house.isInterest
              "
            >
              관심 아파트 해제
            </button>
...
export default {
  ...
  methods: {
    intInsert() {
      ...
      // formData.append("userSeq", this.$store.state.user.userSeq);
      // formData.append("houseNo", this.$store.state.houses.house.aptCode);
      http
