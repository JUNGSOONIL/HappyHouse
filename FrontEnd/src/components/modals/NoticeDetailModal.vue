      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table">
            <tbody>
              <tr>
                <td colspan="4">
                  <strong>제목</strong> : {{ $store.state.boardad.title }}
                </td>
              </tr>
              <tr>
                <td>
                  <strong>작성자</strong> {{ $store.state.boardad.userName }}
                </td>
                <td></td>
                <td class="d-flex justify-content-end">
                  <strong>작성일시</strong>&nbsp;{{
                    $store.state.boardad.regDt
                  }}&nbsp;&nbsp;&nbsp; <strong>조회수</strong>&nbsp;{{
                    $store.state.boardad.readCount
                  }}
                </td>
              </tr>
              <tr>
        ...
        <div class="modal-footer">
          <button
            ...
            data-dismiss="modal"
            type="button"
            style="background-color: #827d78; color: white"
          >
            글 수정하기
          </button>
          <button
